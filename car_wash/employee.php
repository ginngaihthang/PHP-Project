                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form action="" method="post" class=""  autocomplete="off">
                                <button type="button" data-name="<?php echo $employee['name'] ?>" data-birthday="<?php echo $employee['birthday'] ?>" data-salary="<?php echo $employee['salary'] ?>" data-nrc="<?php echo $employee['nrc'];?>" data-address="<?php echo $employee['address'];?>" class="btn btn-sm text-primary detail" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                    <i data-feather="info"></i>
                                </button>
                
                                <a href="edit_employee.php?employee_id=<?php echo $employee['id']; ?>" class="btn btn-sm text-warning"><i data-feather="edit"></i></a>
                                <!-- <a href="#" class="btn btn-sm text-danger delete_emp"><i data-feather="trash"></i></a> -->
