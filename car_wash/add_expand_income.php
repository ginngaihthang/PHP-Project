...
?>
    <div class="container my-4">
        <div class="row col-lg-6 col-md-8 col-12 offset-lg-3 offset-md-2">
            <h3 class=" mb-5">ဝင်ငွေနှင့် အသုံးများ မှတ်ရန်</h3>
            <form action="" method="post" >
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">စုစုပေါင်းဝင်ငွေ</label>
                    <input type="number" class="form-control" name="total-income" id="exampleInputEmail1" placeholder="စုစုပေါင်းဝင်ငွေ" aria-describedby="emailHelp"> 
                </div>
                <div class=" mb-3" id="list">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-5">
                            <input type="number" class="form-control" name="expand_amount[]" placeholder="ပမာဏ" id="exampleInputPassword1">
                        </div>
                    </div>
                </div>
                ...
                <div class=" mb-3" id="employee">
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <input type="number" class="form-control"  name="employee_expand_amount[]" placeholder="ပမာဏ" id="exampleInputPassword1">
                        </div>
                    </div>
                </div>
